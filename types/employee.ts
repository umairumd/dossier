...
// validity window, not yet accepted. Pending: invite sent but the link has
// since expired without being accepted — actionable (needs a resend).
// Active: has signed in at least once. Disabled: is_active=false (banned
